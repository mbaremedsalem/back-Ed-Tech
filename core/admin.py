...
# from assessment.models import Chunk, StudentProgress
...
# from curriculum.admin import SubjectAdmin, UnitAdmin, LessonAdmin
# from assessment.admin import ChunkAdmin, StudentAttemptAdmin, StudentProgressAdmin
...
#             'total_activities': Chunk.objects.count(),
